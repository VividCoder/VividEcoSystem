...
namespace Vivid.Pick
{
  ...
  int screenHeight)
        ...
        public static Vector2 CamTo2D(Vivid.Scene.Cam3D cam, Vector3 pos)
        {
            return Convert(pos, cam.CamWorld, cam.ProjMat, Vivid.App.AppInfo.RW, Vivid.App.AppInfo.RH);
        }
        ...
        public static Ray CamRay(Vivid.Scene.Cam3D cam, int x, int y)
        {
            return MouseRay(cam.ProjMat, cam.CamWorld, new System.Drawing.Size(Vivid.App.AppInfo.RW, Vivid.App.AppInfo.RH), new Vector2(x, y));
        }
    }
}
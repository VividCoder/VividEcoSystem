...
namespace Vivid.ImageProcessing
{
    public static class ImageProcessor
    {
        public static Vivid.PostProcess.Processes.VEBlur FXBlur;
        public static Vivid.FrameBuffer.FrameBufferColor FB;
        public static int IW, IH;
        public static Vivid.PostProcess.VEQuadR QFX = null;
        ...
        public static void InitIP()
        {
            ...
            QFX = new Vivid.PostProcess.VEQuadR();
            GenQuad();
        }

        public static Vivid.Texture.Texture2D BlurImage(Vivid.Texture.Texture2D img, float blur)
        {
            FXBlur.Blur = blur;

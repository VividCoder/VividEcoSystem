...
namespace Vivid.Util.Texture
{
    public class TexTree
    {
        ...
        public Vivid.Texture.TextureRaw Raw;
        ...
        {
            RC = new Rect(0, 0, w, h);
            Raw = new Vivid.Texture.TextureRaw(w, h, false);
            //Root = ne
            //w TreeLeaf (new Rect(0,0,w,h));
        }

        public Vivid.Texture.Texture2D GetMap()
        {
            return new Vivid.Texture.Texture2D(Raw);
        }
